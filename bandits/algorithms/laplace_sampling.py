...
class LaplaceSampling():
    ...
    def __init__(self, name, hparams, optimizer='RMS'):
        ...
        self.update_freq_post = hparams.training_freq
    ...
    def update(self, context, action, reward):
        ...
        self.la = Laplace(self.bnn.net, 'regression', hessian_structure=self.hessian_structure, subset_of_weights='all')
        ...
        if self.t % self.update_freq_post == 0:
